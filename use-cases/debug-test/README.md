# Debug Test Documentation Crawler
...
- **Output Directory**: `output/debug-test/`
- **Merged Output**: `output/debug-test/merged_documentation.md`
...
python use-cases/document-processing/doc_processor.py discover-urls --base-url http://localhost:1313 --save-urls use-cases/debug-test/discovered_urls.txt
...
python use-cases/document-processing/doc_processor.py extract --config use-cases/debug-test/config.json

# 3. Merge extracted documents
python use-cases/document-processing/doc_processor.py merge --config use-cases/debug-test/config.json
```
...
```
output/debug-test/                      # Root output directory
...
use-cases/debug-test/                   # Use case configuration
